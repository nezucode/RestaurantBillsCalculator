...
public class Menu {
	...
	static String[] minuman = {"Iced Americano","Green Tea Frappucino","Air Mineral\t","Vanilla Frappucino","Chamomile Hot Tea"};
	...
	public static void orderPesanan() {
		...
		System.out.print("Silakan pilih kategori menu: ");
	...
	public static void cetakBills() {
		...
		for(int i=0;i < simpanPesanan.size();i++) {
            System.out.println(simpanPesanan.get(i)+ "\tRp. " + simpanHarga.get(i) +"\t\t " + totalItem.get(i) + "\t\tRp. " + simpanHargaTotal.get(i));
		}
		System.out.println("==========================");
